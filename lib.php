...
class plagiarism_plugin_dummy extends plagiarism_plugin {
    /**
    ...
    */
    ...
    /**
     * Hook to display the overall score for the given submission.
     * @return string
     */
    public function get_overall_score($linkarray) {
        return  get_string('dummy_submission_overall_score', 'plagiarism_dummy', rand(1, 100));
    }
}
